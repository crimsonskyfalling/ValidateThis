...
--->
<cfcomponent output="false" name="ClientRuleScripter_Range" extends="AbstractClientRuleScripter" hint="I am responsible for generating JS code for the range validation.">
